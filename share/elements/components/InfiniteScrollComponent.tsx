...
import { InfiniteScroll, InfiniteScrollState } from "./widgets";

export default function InfiniteScrollComponent(props: EngineComponentProps) {
  const element = useElementData(props.elementId, InfiniteScroll);

  useElementEvent(element);

  const elementState = useElementState<InfiniteScrollState>(element);
